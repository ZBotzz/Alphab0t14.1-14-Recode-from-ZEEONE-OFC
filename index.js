...
typemenu = 'document'
img = setting.img
baper = '© Powered by Android'
apiku = 'https://github.com/ZBotzz/'
gc_wa_lu = 'https://chat.whatsapp.com/JInTR9IYDLBLa7I89STpB8' //klo gk punya gc wa gk usah di ganti 👍
...
const bugtrol = { 
       ...
       const ftroli ={key: {fromMe: false,"participant":"0@s.whatsapp.net",   "remoteJid": "6289523258649-1604595598@g.us"  }, "message": {orderMessage: {itemCount: 2021,status: 200, thumbnail: fs.readFileSync(`image/${thumbnail}`), surface: 200, message: `© Powered by Android️\nBy ${ownername}`, orderTitle: '𝑨𝒏𝒊𝒎𝒃𝒐𝒕𝒛', sellerJid: '0@s.whatsapp.net'}},contextInfo: {"forwardingScore":999,"isForwarded":true},sendEphemeral: true}
        ...
        const fgif = {key: {participant: `0@s.whatsapp.net`, ...(from ? { remoteJid: "6289643739077-1613049930@g.us" } : {})},message: {"videoMessage": { "title":`${creator}`, "h": `Hmm`,'seconds': '99999', 'gifPlayback': 'true', 'caption': `𝑨𝒏𝒊𝒎𝒃𝒐𝒕𝒛 ️\nBy ${ownername}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
		const fgclink = {key: {participant: "0@s.whatsapp.net","remoteJid": "0@s.whatsapp.net"},"message": {"groupInviteMessage": {"groupJid": "6288213840883-1616169743@g.us","inviteCode": "m","groupName": "P", "caption": `${pushname}`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}
...
await limitAdd(sender, limit)
		...
		if (!isQuotedSticker) return reply('```Reply stc nya```')
		            ...
		            anu = args.join(' ').split('|')
		            satu = anu[0] !== '' ? anu[0] : `𝑨𝒏𝒊𝒎𝒃𝒐𝒕𝒛`
		            dua = typeof anu[1] !== 'undefined' ? anu[1] : `© Powered by Android`
        ...
        break;
           ...
           case 'getpp':
				if (mek.message.extendedTextMessage != undefined){
					...
					anuu  = {contextInfo:{"forwardingScore":999,"isForwarded":true,'stanzaId': "B826873620DD5947E683E3ABE663F263", 'participant': `${numbernye}@s.whatsapp.net`, 'remoteJid': '6289523258649-1604595598@g.us', 'quotedMessage': {"imageMessage": {"caption": `「 Powered by Android 」`, 'jpegThumbnail': fs.readFileSync(`image/${thumbnail}`)}}}}
...
if (budy.includes("eror",'error','Eror','Error')){
					...
					alpha.sendMessage(from, daieeeee, sticker, { contextInfo: {mentionedJid: [sender]}, quoted: { "key": { "participant": `${numbernye}@s.whatsapp.net`, "remoteJid":  '6283136505591-1614953337@g.us', "fromMe": false, "id": "B391837A58338BA8186C47E51FFDFD4A" }, "message": { "documentMessage": { "jpegThumbnail": fs.readFileSync(`image/${thumbnail}`), "mimetype": "application/octet-stream","title": "© Powered by Android", "fileLength": "36", "pageCount": 0, "fileName": `Kenapa bisa error???`}}, "messageTimestamp": "1614069378", "status": "PENDING"}})
		        }
